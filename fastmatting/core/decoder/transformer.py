...
from fastmatting.layers import MLPBlock
...
class TwoWayTransformer(nn.Module):
    def __init__(
        ...
        Args:
          ...
          num_heads (int): the number of decoder for multihead attention. Must
...
class TwoWayAttentionBlock(nn.Module):
    def __init__(
        ...
        Arguments:
          ...
          num_heads (int): the number of decoder in the attention layers
